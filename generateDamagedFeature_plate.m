function [stiffness, mass]=generateDamagedFeature_plate(data,boundary_conditions,...
                                            damagedElements,severity)
  %%
  % EXPANDING DATA
  thickness = data(3);
  E1        = data(4);
...
E(1,damagedElements)=severity*E1;
G12(1,damagedElements) = severity*data(11);
E1=E;
E2=E;
